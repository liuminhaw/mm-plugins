module github.com/liuminhaw/mm-plugins
...
require (
	...
	github.com/liuminhaw/mist-miner v0.0.0-20240812143013-d69cdc27dd12
)

// replace github.com/liuminhaw/mist-miner => ../mist-miner
